...
from metrics import iou_score, dice_coef, jac, get_precision
...
def parse_args():
    ...
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='TransUNet',  # 修改模型的名字
                        choices=ARCH_NAMES,
...
def main():
    ...
    for epoch in range(config['epochs']):
        ...
        print(
            'loss %.4f - iou %.4f - dice %.4f - jaccard %.4f - val_loss %.4f - val_iou %.4f - val_dice %.4f - val_jaccard %.4f'
            % (train_log['loss'], train_log['iou'], train_log['dice'], train_log['jaccard'],
               val_log['loss'], val_log['iou'], val_log['dice'], val_log['jaccard']))
